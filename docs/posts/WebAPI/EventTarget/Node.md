...
**DOM 树完全由 Node 对象组成**，每一个节点都是 `Node` 的实例或继承自 `Node` 的对象。

Node将组织成一个DOM树，DOM树的节点可以是Document、Element、Text、Comment。
...
![image-20260105225729170](./assets/image-20260105225729170.png)
