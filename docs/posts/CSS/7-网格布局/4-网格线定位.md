...
一个grid元素可以跨越多行或者多列，我们可以制定一个 **Grid 子元素的起止位置**。
...
![image-20251117211016976](C:\Users\lai\WebstormProjects\vitePress\docs\posts\CSS\7-网格布局\assets\image-20251117211016976.png)
